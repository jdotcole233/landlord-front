    ...
    <ul>
      ...
      <li>
        <Link
          onClick={() => setMobileMenu(false)}
          className={`${
            location.pathname === "/profile" ? "bg-blue-300 text-blue-700" : ""
          } flex border-b hover:bg-blue-500 hover:text-blue-800 border-b-gray-200 py-2 px-5`}
          to="/profile"
        >
          <span>
      ...
      <li>
        <Link
          onClick={() => setMobileMenu(false)}
          className={`${
            location.pathname === "/password" ? "bg-blue-300 text-blue-700" : ""
          } flex border-b hover:bg-blue-500 hover:text-blue-800 border-b-gray-200 py-2 px-5`}
          to="/password"
        >
          <span>
      ...
      <li className="flex py-2 px-5 cursor-pointer hover:text-red-500">
        ...
        <span className="ml-2 font-semibold active:text-[#00aaff]">Logout</span>
      </li>
    </ul>
  );
};
